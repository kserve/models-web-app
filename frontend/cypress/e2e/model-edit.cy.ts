describe('Models Web App - Model Edit Tests', () => {
  ...
  beforeEach(() => {
    ...
    cy.intercept('GET', '/api/namespaces/kubeflow-user/inferenceservices/test-sklearn-model', {
      statusCode: 200,
      body: {
    ...
    cy.intercept('GET', '/api/namespaces/kubeflow-user/revisions/test-sklearn-model-predictor-00001', {
      statusCode: 200,
      body: {
        knativeRevision: {
          metadata: {
    ...
    cy.intercept('GET', '/api/namespaces/kubeflow-user/configurations/test-sklearn-model-predictor', {
      statusCode: 200,
      body: {
    ...
    cy.intercept('GET', '/api/namespaces/kubeflow-user/knativeServices/test-sklearn-model-predictor', {
      statusCode: 200,
      body: {
        knativeService: {
          metadata: {
    ...
    cy.intercept('GET', '/api/namespaces/kubeflow-user/routes/test-sklearn-model-predictor', {
      statusCode: 200,
      body: {
        knativeRoute: {
          metadata: {
  ...
  it('should successfully submit edited model', () => {
    ...
    cy.intercept('PUT', '/api/namespaces/kubeflow-user/inferenceservices/test-sklearn-model', {
      statusCode: 200,
      body: {
        success: true,
    ...
    cy.window().then((win: any) => {
      ...
      const updatedValue = currentValue
        .replace('gs://test-bucket/sklearn-model', 'gs://test-bucket/updated-sklearn-model')

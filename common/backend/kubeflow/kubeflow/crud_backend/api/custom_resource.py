...
def create_custom_rsrc(group, version, kind, data, namespace):
    ...
    return custom_api.create_namespaced_custom_object(
        group, version, namespace, kind, data
    )


def delete_custom_rsrc(group, version, kind, name, namespace, policy="Foreground"):
...
def list_custom_rsrc(group, version, kind, namespace):
    ...
    return custom_api.list_namespaced_custom_object(group, version, namespace, kind)
